...
if __name__ == "__main__":
    # 입력(읽기) 경로
    seqA_rgb   = "/home/pchy0316/baseline_project/concept-graphs-ali-dev/ai2thor/data/FloorPlan213_change1/color"
    seqA_depth = "/home/pchy0316/baseline_project/concept-graphs-ali-dev/ai2thor/data/FloorPlan213_change1/depth"
    seqB_rgb   = "/home/pchy0316/baseline_project/concept-graphs-ali-dev/ai2thor/data/FloorPlan213_change2/color"
    seqB_depth = "/home/pchy0316/baseline_project/concept-graphs-ali-dev/ai2thor/data/FloorPlan213_change2/depth"
    # 오타 주의: change2
    seqB_pose  = "/home/pchy0316/baseline_project/concept-graphs-ali-dev/ai2thor/data/FloorPlan213_change2/pose"

    # 출력 베이스
    out_dir = "/home/pchy0316/dataset/my_local_data/Replica/room0_sub".strip()
    ensure_dir(out_dir)

    # 서브 폴더
    pre_dir         = os.path.join(out_dir, "pre_results")          # seqA_rgb + seqB_depth
    ...
    B_pre_dir         = os.path.join(out_dir, "B_pre_results")          # seqA_rgb + seqB_depth
