...
# # New_script_Start # old save gaussian
...
# # New_script_End Old_gaussian

    # New_script_Start New_gaussian
    # =========================
    # Coarse Gaussian Mixture (Object-level) from obj["pcd"]
    # + (NEW) sample a few representative RGB points per gaussian cluster and store them
    # + (NEW) store obj_index(loop index) and obj["class_name"] into each gaussian
    # Paste this under:  # LOOP OVER -----------------------------------------------
    # =========================
...
# New_script_Start
    orr_log_final_objs_gaussian_saved_samples(objects, obj_classes)
# New_script_End
...
# New_script_Start
    ...
    export_objects_gaussians_and_samples(objects, ply_path)
